...
/**
 * @extends ServiceEntityRepository<SimNumber>
 *
...
class SimNumberRepository extends ServiceEntityRepository
{
    ...
    public function save(SimNumber $entity, bool $flush = false): void
    {
    ...
    public function remove(SimNumber $entity, bool $flush = false): void
    {
